...
$body$;
revoke all     on function code.master_and_details_report() from public;
grant  execute on function code.master_and_details_report() to   d4$client;

--------------------------------------------------------------------------------

create type code.join_facts as (m text, ds text[], mk int, m_dk int, dks int[]);
revoke all   on type code.join_facts from public;
grant  usage on type code.join_facts to   d4$client;
...
$body$;
revoke all     on function code.decorated_master_and_details_report() from public;
grant  execute on function code.decorated_master_and_details_report() to   d4$client;
