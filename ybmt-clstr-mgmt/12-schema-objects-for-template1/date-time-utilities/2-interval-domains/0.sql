...
$body$;
revoke all     on function dt_utils.mm_value_ok(int) from public;
grant  execute on function dt_utils.mm_value_ok(int) to   public;
...
$body$;
revoke all     on function dt_utils.interval_months_ok(interval) from public;
grant  execute on function dt_utils.interval_months_ok(interval) to   public;
...
revoke all   on domain dt_utils.interval_months_t from public;
grant  usage on domain dt_utils.interval_months_t to   public;
...
$body$;
revoke all     on function dt_utils.dd_value_ok(int) from public;
grant  execute on function dt_utils.dd_value_ok(int) to   public;
...
$body$;
revoke all     on function dt_utils.interval_days_ok(interval) from public;
grant  execute on function dt_utils.interval_days_ok(interval) to   public;

create domain dt_utils.interval_days_t as interval
constraint interval_days_ok check(dt_utils.interval_days_ok(value));
revoke all   on domain dt_utils.interval_days_t from public;
grant  usage on domain dt_utils.interval_days_t to   public;
...
$body$;
revoke all     on function dt_utils.ss_value_ok(double precision) from public;
grant  execute on function dt_utils.ss_value_ok(double precision) to   public;
...
$body$;
revoke all     on function dt_utils.interval_seconds_ok(interval) from public;
grant  execute on function dt_utils.interval_seconds_ok(interval) to   public;
...
revoke all   on domain dt_utils.interval_seconds_t from public;
grant  usage on domain dt_utils.interval_seconds_t to   public;
...
$body$;
revoke all     on function dt_utils.interval_months(int, int) from public;
grant  execute on function dt_utils.interval_months(int, int) to   public;
...
$body$;
revoke all     on function dt_utils.interval_months(timestamptz, timestamptz) from public;
grant  execute on function dt_utils.interval_months(timestamptz, timestamptz) to   public;
...
$body$;
revoke all     on function dt_utils.interval_months(dt_utils.interval_months_t, double precision) from public;
grant  execute on function dt_utils.interval_months(dt_utils.interval_months_t, double precision) to   public;
...
$body$;
revoke all     on function dt_utils.interval_days(int) from public;
grant  execute on function dt_utils.interval_days(int) to   public;
...
$body$;
revoke all     on function dt_utils.interval_days(timestamptz, timestamptz) from public;
grant  execute on function dt_utils.interval_days(timestamptz, timestamptz) to   public;
...
$body$;
revoke all     on function dt_utils.interval_days(dt_utils.interval_days_t, double precision) from public;
grant  execute on function dt_utils.interval_days(dt_utils.interval_days_t, double precision) to   public;
...
$body$;
revoke all     on function dt_utils.interval_seconds(int, int, double precision) from public;
grant  execute on function dt_utils.interval_seconds(int, int, double precision) to   public;
...
$body$;
revoke all     on function dt_utils.interval_seconds(timestamptz, timestamptz) from public;
grant  execute on function dt_utils.interval_seconds(timestamptz, timestamptz) to   public;
...
$body$;
revoke all     on function dt_utils.interval_seconds(dt_utils.interval_seconds_t, double precision) from public;
grant  execute on function dt_utils.interval_seconds(dt_utils.interval_seconds_t, double precision) to   public;
