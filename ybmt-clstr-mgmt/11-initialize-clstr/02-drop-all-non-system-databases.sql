/*
  ...
  we need to use a function to create the text of a ".sql" script,
  spool it to a file with "\o", and then execute that script with "\i".
  The last line in the script will be "\! rm ..." to delete itself.
*/;
--------------------------------------------------------------------------------
