...
begin
  begin
    call ext_tz_names.assert_acceptable_timezone_interval(make_interval(hours=>11));
  exception when others then
    assert false, 'test_assert_approved_timezone_name(): logic error #1.';
  end;

  begin
    call ext_tz_names.assert_acceptable_timezone_interval(make_interval(hours=>23));
  ...
  begin
    call ext_tz_names.assert_acceptable_timezone_interval(make_interval(secs=>13.12345));
