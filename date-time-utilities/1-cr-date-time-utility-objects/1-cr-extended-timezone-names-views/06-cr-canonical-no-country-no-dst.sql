...
call mgr.revoke_all_from_public('view', 'ext_tz_names.canonical_no_country_no_dst');
call mgr.grant_priv(  'select', 'view', 'ext_tz_names.canonical_no_country_no_dst', 'public');
