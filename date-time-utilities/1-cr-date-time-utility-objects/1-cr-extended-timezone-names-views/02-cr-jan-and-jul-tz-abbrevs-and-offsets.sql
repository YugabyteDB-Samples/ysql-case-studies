...
revoke all     on function ext_tz_names.jan_and_jul_tz_abbrevs_and_offsets() from public;
grant  execute on function ext_tz_names.jan_and_jul_tz_abbrevs_and_offsets() to   public;
