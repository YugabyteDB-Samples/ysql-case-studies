...
revoke all    on table ext_tz_names.canonical_real_country_with_dst from public;
grant  select on table ext_tz_names.canonical_real_country_with_dst to   public;
