...
grant  select on table mgr.proper_ybmt_roles to   public;
--------------------------------------------------------------------------------
...
grant  select on table mgr.improper_ybmt_roles to   public;
--------------------------------------------------------------------------------
...
grant  execute on function mgr.improper_ybmt_roles() to    public;
