...
$body$;
call mgr.revoke_all_from_public('procedure', 'qa_code.insert_master_and_details(code.m_and_ds)');
--------------------------------------------------------------------------------
...
as $body$
  ...
  order by 1;
$body$;
call mgr.revoke_all_from_public('function', 'qa_code.master_and_details_report_all_rows()');
--------------------------------------------------------------------------------
...
$body$;
call mgr.revoke_all_from_public('function', 'qa_code.master_and_details_report_one_row(text)');
