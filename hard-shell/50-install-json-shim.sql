...
call mgr.revoke_all_from_public('schema', 'json_helpers');
call mgr.grant_priv(   'usage', 'schema', 'json_helpers', 'qa');
...
create schema json_shim;
call mgr.revoke_all_from_public('schema', 'json_shim');
call mgr.grant_priv(   'usage', 'schema', 'json_shim', 'api');
...
$body$;
call mgr.revoke_all_from_public('procedure', 'json_shim.insert_master_and_details(text, text)');
call mgr.grant_priv( 'execute', 'procedure', 'json_shim.insert_master_and_details(text, text)', 'api');
...
$body$;
call mgr.revoke_all_from_public('procedure', 'json_shim.do_master_and_details_report(text, text)');
call mgr.grant_priv( 'execute', 'procedure', 'json_shim.do_master_and_details_report(text, text)', 'api');
