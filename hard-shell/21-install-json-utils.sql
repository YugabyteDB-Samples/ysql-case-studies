...
create schema json_utils;
call mgr.revoke_all_from_public('schema', 'json_utils');
call mgr.grant_priv(   'usage', 'schema', 'json_utils', 'code');
call mgr.grant_priv(   'usage', 'schema', 'json_utils', 'api');
call mgr.grant_priv(   'usage', 'schema', 'json_utils', 'qa');
--------------------------------------------------------------------------------
/*
...
create type json_utils.outcome_codes as enum (
  ...
  'client code error',
  'unexpected error');
call mgr.revoke_all_from_public('type', 'json_utils.outcome_codes');
call mgr.grant_priv(   'usage', 'type', 'json_utils.outcome_codes', 'code');
...
$body$;
call mgr.revoke_all_from_public('function', 'json_utils.bare_success()');
call mgr.grant_priv( 'execute', 'function', 'json_utils.bare_success()', 'qa');
...
$body$;
call mgr.revoke_all_from_public('function', 'json_utils.expected_error(json_utils.outcome_codes, text)');
call mgr.grant_priv( 'execute', 'function', 'json_utils.expected_error(json_utils.outcome_codes, text)', 'qa');
...
$body$;
call mgr.revoke_all_from_public('function', 'json_utils.unexpected_error(int)');
call mgr.grant_priv( 'execute', 'function', 'json_utils.unexpected_error(int)', 'api');

--------------------------------------------------------------------------------
-- Function json_object_keys_ok() 

create type json_utils.key_facts as (name text, data_type text, required boolean);
call mgr.revoke_all_from_public('type', 'json_utils.key_facts');
call mgr.grant_priv(   'usage', 'type', 'json_utils.key_facts', 'qa');
...
$body$;
call mgr.revoke_all_from_public('function', 'json_utils.json_object_keys_ok(text, json_utils.key_facts[])');
call mgr.grant_priv( 'execute', 'function', 'json_utils.json_object_keys_ok(text, json_utils.key_facts[])', 'qa');
...
$body$;
call mgr.revoke_all_from_public('function', 'json_utils.array_elements_all_same_type(jsonb, text, text)');
call mgr.grant_priv( 'execute', 'function', 'json_utils.array_elements_all_same_type(jsonb, text, text)', 'qa');
