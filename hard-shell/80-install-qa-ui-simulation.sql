...
create schema qa_ui_simulation;
--------------------------------------------------------------------------------
...
$body$;
call mgr.revoke_all_from_public('function', 'qa_ui_simulation.pretty_api_outcome(text)');
call mgr.grant_priv( 'execute', 'function', 'qa_ui_simulation.pretty_api_outcome(text)', 'client');
--------------------------------------------------------------------------------
...
$body$;
call mgr.revoke_all_from_public('function', 'qa_ui_simulation.ui_simulation_insert(text, text[])');
call mgr.grant_priv( 'execute', 'function', 'qa_ui_simulation.ui_simulation_insert(text, text[])', 'client');
--------------------------------------------------------------------------------
...
$body$;
call mgr.revoke_all_from_public('function', 'qa_ui_simulation.ui_simulation_report(text)');
call mgr.grant_priv( 'execute', 'function', 'qa_ui_simulation.ui_simulation_report(text)', 'client');
