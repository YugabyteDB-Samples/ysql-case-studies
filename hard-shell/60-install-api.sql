...
call mgr.set_role('api');
call mgr.revoke_all_from_public('schema', 'api');
call mgr.grant_priv(   'usage', 'schema', 'api', 'client');
call mgr.grant_priv(   'usage', 'schema', 'api', 'qa');
...
$body$;
call mgr.revoke_all_from_public('procedure', 'api.insert_master_and_details(text, text)');
call mgr.grant_priv( 'execute', 'procedure', 'api.insert_master_and_details(text, text)', 'client');
call mgr.grant_priv( 'execute', 'procedure', 'api.insert_master_and_details(text, text)', 'qa');
--------------------------------------------------------------------------------
...
$body$;
call mgr.revoke_all_from_public('procedure', 'api.do_master_and_details_report(text, text)');
call mgr.grant_priv( 'execute', 'procedure', 'api.do_master_and_details_report(text, text)', 'client');
call mgr.grant_priv( 'execute', 'procedure', 'api.do_master_and_details_report(text, text)', 'qa');
