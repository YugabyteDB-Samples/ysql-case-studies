...
create schema code_helpers;

-- For unit testing code and ad hoc demo code.
call mgr.revoke_all_from_public('schema', 'code_helpers');
call mgr.grant_priv(   'usage', 'schema', 'code_helpers', 'qa');
...
$body$;
call mgr.revoke_all_from_public('function', 'code_helpers.details_dups(boolean, uuid, text[])');

create type code_helpers.mk_and_ds as (mk uuid, ds text[]);
call mgr.revoke_all_from_public('type', 'code_helpers.mk_and_ds');
call mgr.grant_priv(   'usage', 'type', 'code_helpers.mk_and_ds', 'qa');

--------------------------------------------------------------------------------
-- FOR THE code SCHEMA.

call mgr.revoke_all_from_public('schema', 'code');
call mgr.grant_priv(   'usage', 'schema', 'code', 'json');

create type code.m_and_ds as (m text,  ds text[]);
call mgr.revoke_all_from_public('type', 'code.m_and_ds');
call mgr.grant_priv(   'usage', 'type', 'code.m_and_ds', 'json');

-- For unit testing code and ad hoc demo code.
call mgr.grant_priv('usage', 'schema', 'code', 'qa');
call mgr.grant_priv('usage', 'type', 'code.m_and_ds', 'qa');
...
$body$;
call mgr.revoke_all_from_public('procedure', 'code.insert_master_and_details(code.m_and_ds, json_utils.outcome_codes, text)');
call mgr.grant_priv( 'execute', 'procedure', 'code.insert_master_and_details(code.m_and_ds, json_utils.outcome_codes, text)', 'json');
call mgr.grant_priv( 'execute', 'procedure', 'code.insert_master_and_details(code.m_and_ds, json_utils.outcome_codes, text)', 'qa');
...
$body$;
call mgr.revoke_all_from_public( 'procedure', 'code.do_master_and_details_report(text, code.m_and_ds, json_utils.outcome_codes, text)');
call mgr.grant_priv(  'execute', 'procedure', 'code.do_master_and_details_report(text, code.m_and_ds, json_utils.outcome_codes, text)', 'json');
call mgr.grant_priv(  'execute', 'procedure', 'code.do_master_and_details_report(text, code.m_and_ds, json_utils.outcome_codes, text)', 'qa');
